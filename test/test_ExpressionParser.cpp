...
BOOST_AUTO_TEST_CASE(parametericExpressions) {
  ...
  MinuitParameterSet mps({new MinuitParameter("a", Flag::Free, a, 0.), new MinuitParameter("b", Flag::Free, b, 0.), new MinuitParameter("c", Flag::Free, c, 0.),
                          new MinuitParameter("d", Flag::Free, d, 0.), new MinuitParameter("f", Flag::Free, f, 0.)});
