...
BOOST_AUTO_TEST_CASE(constructor) { Tensor A({"A_11", "A_12", "A_13", "A_21", "A_22", "A_23"}, Tensor::dim(2, 3)); }

BOOST_AUTO_TEST_CASE(multiply) {
  Tensor::Index a, b, c;
  Tensor A({1, 2, 3, 4, 5, 6}, Tensor::dim(2, 3));
  Tensor B({7, 8, 9, 10, 11, 12}, Tensor::dim(3, 2));
