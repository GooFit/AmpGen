...
BOOST_AUTO_TEST_CASE(test_AmplitudeRules_constructor) {
  auto mps = MinuitParameterSet(
    {new MinuitParameter("D0{K*(892)bar0,pi0}_Re", Flag::Fix, 1., 0.), new MinuitParameter("D0{K*(892)bar0,pi0}_Im", Flag::Fix, 1., 0.),
     new MinuitParameter("D0{rho(770)+,pi-}_Re", Flag::Fix, 1., 0.), new MinuitParameter("D0{rho(770)+,pi-}_Im", Flag::Fix, 2., 0.),
     new MinuitParameter("K*(892)bar0{K-,pi+}_Re", Flag::Free, sqrt(1. / 3.), 0.), new MinuitParameter("K*(892)bar0{K-,pi+}_Im", Flag::Free, 0, 0.),
     new MinuitParameter("K*(892)bar0{K0,pi0}_Re", Flag::Fix, sqrt(2. / 3.), 0.), new MinuitParameter("K*(892)bar0{K0,pi0}_Im", Flag::Fix, 0, 0.)});
