...
set(ENABLE_INSTALL     TRUE    CACHE BOOL   "ENABLE_INSTALL") # flag to enable gaudi_installs (switched off to make Travis happier) 
...
#gaudi_add_library(${PROJECT_NAME} SHARED ${AMPGEN_SRC} ${AMPGEN_HDR} NO_PUBLIC_HEADERS)
#gaudi_add_library(${PROJECT_NAME}::${PROJECT_NAME} ALIAS ${PROJECT_NAME} NO_PUBLIC_HEADERS)
...
if( ENABLE_FITTING AND USE_ROOT )
  if( ( NOT TARGET ROOT::Minuit2 AND NOT TARGET Minuit2 ) OR "${extern_minuit2}" )
    ...
    gaudi_add_library(ROOT::Minuit2 ALIAS Minuit2)
...
if( USE_OPENMP )
  ...
  if(OpenMP_FOUND OR OpenMP_CXX_FOUND)
    if(NOT TARGET OpenMP::OpenMP_CXX)
      gaudi_add_library(OpenMP::OpenMP_CXX IMPORTED INTERFACE)
...
foreach( file ${applications} )
  ...
  gaudi_add_executable(${Executable}.exe ${file})
...
# stuff related to export, gaudi_install and version tagging
...
if( ENABLE_INSTALL ) 
  gaudi_install( FILES ${CMAKE_CURRENT_BINARY_DIR}/AmpGenConfig.cmake
  ...
  gaudi_install(EXPORT "AmpGenTargets"
          NAMESPACE "AmpGen::"
          DESTINATION ${CMAKE_INSTALL_DATADIR}/AmpGen/cmake
  )
