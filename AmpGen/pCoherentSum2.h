#ifndef AMPGEN_pCOHERENTSUM2_H
#define AMPGEN_pCOHERENTSUM2_H
...
namespace AmpGen
{
  ...
  */
  class pCoherentSum2 // : public functional::pdf_base<pCoherentSum2>
  {
  public:
    pCoherentSum2();
    pCoherentSum2( const EventType& type, const AmpGen::MinuitParameterSet& mps, const std::string& prefix = "" );
    virtual ~pCoherentSum2() = default; 
