...
namespace AmpGen
{
  ...
  extern const std::array<Tensor, 5> Gamma; // Gamma matrices, orderered weirdly due to ROOT convention, so Gamma[{0,1,2}] = gamma[{1,2,3}] and Gamma[3] =
                                            // gamma[0] where gamma are the gamma matrices in the more conventional ordering.
