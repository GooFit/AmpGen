#ifndef AMPGEN_PCOHERENTSUM_H
#define AMPGEN_PCOHERENTSUM_H
...
namespace AmpGen
{
  ...
  */
  class pCoherentSum // : public functional::pdf_base<pCoherentSum>
  {
  public:
    pCoherentSum();
    pCoherentSum( const EventType& type, const AmpGen::MinuitParameterSet& mps, const std::string& prefix = "" );
