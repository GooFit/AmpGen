...
namespace AmpGen{
    class PhaseCorrection{
        public:
            Expression fastLegendre(Expression x, size_t n){
                switch (n)
                    {
                    ...
                    case 1:
                        return x;
                    case 2:
                        return 1.5*fcn::pow(x, 2) - 0.5;
                    case 3:
                        return 2.5*fcn::pow(x, 3) - 1.5*x;
                    case 4:
                        return 4.375*fcn::pow(x, 4) - 3.75*fcn::pow(x, 2) + 0.375;
                    case 5:
                        return 7.875*fcn::pow(x, 5) - 8.75*fcn::pow(x, 3) + 1.875*x;
                    case 6:
                        return 14.4375*fcn::pow(x, 6) - 19.6875*fcn::pow(x, 4) + 6.5625*fcn::pow(x, 2) - 0.3125;
                    case 7:
                        return 26.8125*fcn::pow(x, 7) - 43.3125*fcn::pow(x, 5) + 19.6875*fcn::pow(x, 3) - 2.1875*x;
                    case 8:
                        return 50.2734375*fcn::pow(x, 8) - 93.84375*fcn::pow(x, 6) + 54.140625*fcn::pow(x, 4) - 9.84375*fcn::pow(x, 2) + 0.2734375;
                    case 9:
                        return 94.9609375*fcn::pow(x, 9) - 201.09375*fcn::pow(x, 7) + 140.765625*fcn::pow(x, 5) - 36.09375*fcn::pow(x, 3) + 2.4609375*x;
                    case 10:
                        return 180.42578125*fcn::pow(x, 10) - 427.32421875*fcn::pow(x, 8) + 351.9140625*fcn::pow(x, 6) - 117.3046875*fcn::pow(x, 4) + 13.53515625*fcn::pow(x, 2) - 0.24609375;
                    case 11:
                        return 344.44921875*fcn::pow(x, 11) - 902.12890625*fcn::pow(x, 9) + 854.6484375*fcn::pow(x, 7) - 351.9140625*fcn::pow(x, 5) + 58.65234375*fcn::pow(x, 3) - 2.70703125*x;
                    case 12:
                        return 660.1943359375*fcn::pow(x, 12) - 1894.470703125*fcn::pow(x, 10) + 2029.7900390625*fcn::pow(x, 8) - 997.08984375*fcn::pow(x, 6) + 219.9462890625*fcn::pow(x, 4) - 17.595703125*fcn::pow(x, 2) + 0.2255859375;
                    case 13:
                        return 1269.6044921875*fcn::pow(x, 13) - 3961.166015625*fcn::pow(x, 11) + 4736.1767578125*fcn::pow(x, 9) - 2706.38671875*fcn::pow(x, 7) + 747.8173828125*fcn::pow(x, 5) - 87.978515625*fcn::pow(x, 3) + 2.9326171875*x;
                    case 14:
                        return 2448.52294921875*fcn::pow(x, 14) - 8252.42919921875*fcn::pow(x, 12) + 10893.2065429688*fcn::pow(x, 10) - 7104.26513671875*fcn::pow(x, 8) + 2368.08837890625*fcn::pow(x, 6) - 373.90869140625*fcn::pow(x, 4) + 21.99462890625*fcn::pow(x, 2) - 0.20947265625;
                    case 15:
                        return 4733.81103515625*fcn::pow(x, 15) - 17139.6606445313*fcn::pow(x, 13) + 24757.2875976563*fcn::pow(x, 11) - 18155.3442382812*fcn::pow(x, 9) + 7104.26513671875*fcn::pow(x, 7) - 1420.85302734375*fcn::pow(x, 5) + 124.63623046875*fcn::pow(x, 3) - 3.14208984375*x;
                    case 16:
                        return 9171.75888061523*fcn::pow(x, 16) - 35503.5827636719*fcn::pow(x, 14) + 55703.8970947266*fcn::pow(x, 12) - 45388.3605957031*fcn::pow(x, 10) + 20424.7622680664*fcn::pow(x, 8) - 4972.98559570313*fcn::pow(x, 6) + 592.022094726563*fcn::pow(x, 4) - 26.707763671875*fcn::pow(x, 2) + 0.196380615234375;
                    case 17:
                        return 17804.002532959*fcn::pow(x, 17) - 73374.0710449219*fcn::pow(x, 15) + 124262.539672852*fcn::pow(x, 13) - 111407.794189453*fcn::pow(x, 11) + 56735.4507446289*fcn::pow(x, 9) - 16339.8098144531*fcn::pow(x, 7) + 2486.49279785156*fcn::pow(x, 5) - 169.149169921875*fcn::pow(x, 3) + 3.33847045898438*x;
                    case 18:
                        return 34618.8938140869*fcn::pow(x, 18) - 151334.021530151*fcn::pow(x, 16) + 275152.766418457*fcn::pow(x, 14) - 269235.502624512*fcn::pow(x, 12) + 153185.717010498*fcn::pow(x, 10) - 51061.905670166*fcn::pow(x, 8) + 9531.55572509766*fcn::pow(x, 6) - 888.033142089844*fcn::pow(x, 4) + 31.7154693603516*fcn::pow(x, 2) - 0.185470581054688;
                    case 19:
                        return 67415.7405853271*fcn::pow(x, 19) - 311570.044326782*fcn::pow(x, 17) + 605336.086120605*fcn::pow(x, 15) - 642023.121643066*fcn::pow(x, 13) + 403853.253936768*fcn::pow(x, 11) - 153185.717010498*fcn::pow(x, 9) + 34041.2704467773*fcn::pow(x, 7) - 4084.95245361328*fcn::pow(x, 5) + 222.008285522461*fcn::pow(x, 3) - 3.52394104003906*x;
                    default:
                        return (2 * n - 1)/n * x * fastLegendre(x, n - 1) - (n - 1)/n * fastLegendre(x, n - 2);
                    }
            
            }
            PhaseCorrection(const MinuitParameterSet& mps) : m_mps(mps), m_order(NamedParameter<size_t>("pCorrelatedSum::Order", 2)), m_debug(NamedParameter<bool>("PhaseCorrection::debug", true)) {}
            std::vector<Expression> getXY(Event event){
                 auto x = event.s(0,1);
                auto y = event.s(0,2);
                auto z = event.s(1,2);
                ...
                auto zp = (X+Y)/2;
                auto zm = (X-Y)/2;
                return std::vector<Expression>({zp,zm});
            ...
            std::function<Expression(Expression,Expression,size_t,MinuitParameterSet)> makefunc(){
                size_t order = m_order;
                std::function<Expression(Expression,Expression,int,MinuitParameterSet)> f = 
                    [](Expression x, Expression y,size_t order, MinuitParameterSet mps){
                        Expression corr=0; 
                        ...
                        Expression sum_i=0;
                            ...
                            sum_i += Cij*fcn::legendre(x,i) * fcn::legendre(y,2*j+1);
                            }
                        corr += sum_i;
                        }
