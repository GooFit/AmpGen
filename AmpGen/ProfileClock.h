...
namespace AmpGen
{
  ...
  template <int N, class FCN> double Profile(const FCN &fcn, const std::string &name = "")
  {
    ProfileClock t;
  ...
  template <int N, class FCN> double ProfileWithStat(const FCN &fcn, const std::string &name = "")
  {
    double t = 0;
    double t2 = 0;
    double tmin = 1e9;
  ...
  template <int N, class FCN> double Profile2(const FCN &fcn)
  {
    ProfileClock t;
    auto z = 0;
    for(size_t i = 0; i < N; ++i)
