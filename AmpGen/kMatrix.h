...
namespace AmpGen {
  namespace Lineshape {
    /** @ingroup Lineshapes class kMatrix
        ...
        Describes the isoscalar @f$ \pi\pi, KK, 4\pi \eta\eta, \eta\eta^\prime@f$ S-wave in terms of a five-by-five K-matrix and corresponding P-vector
       couplings. Includes a large number of parameters that can be fixed from the above publication. These parameters can be found in the options directory,
       which in turn can be includes in the fit by adding
